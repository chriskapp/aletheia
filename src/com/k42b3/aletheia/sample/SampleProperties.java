...
public class SampleProperties extends JFrame
{
	private Properties properties;
	private SamplePropertiesCallback callback;

	private PropertiesTableModel model;
	private JTable table;

	public SampleProperties(Properties properties, SamplePropertiesCallback callback)
	{
		super();
